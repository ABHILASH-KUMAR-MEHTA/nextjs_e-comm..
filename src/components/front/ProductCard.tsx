...
const ProductCard = ({ id, img, category, title, price }: propsType) => {
  ...
  return (
    <div className="border border-gray-200 rounded-md">
      <div className="text-center border-b rounded-lg border-gray-200">
      ...
      <div className="px-8 py-4">
        ...
        <div className="mt-3 flex text-[#FFB21D] items-center">
          ...
          <AiFillStar />
          <AiOutlineStar />
          <p className="text-gray-500 text-[14px] ml-2">(3 Review) </p>
        </div>
        <div className="flex justify-between items-center mt-4">
          <h2 className="font-medium text-accent text-xl">${price}</h2>
          <div
            className="flex gap-2 items-center bg-pink text-white px-4 py-2 rounded-lg cursor-pointer hover:bg-accent"
